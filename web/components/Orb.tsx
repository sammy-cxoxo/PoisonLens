...
// Move shader strings outside component to prevent recreation
...
export default function Orb({
  ...
  // Store props in refs to avoid effect dependencies
  ...
  useEffect(() => {
    ...
    const update = (t: number) => {
      ...
      const dt = (t - lastTimeRef.current) * 0.001;
      ...
      const effectiveHover = props.forceHoverState ? 1 : targetHoverRef.current;
      program.uniforms.hover.value += (effectiveHover - program.uniforms.hover.value) * 0.1;

      if (props.rotateOnHover && effectiveHover > 0.5) {
        currentRotRef.current += dt * 0.3;
      }
      program.uniforms.rot.value = currentRotRef.current;
  ...
  }, []); // Empty dependency array - props are accessed via ref
